...
df <- read.csv("Caused of Deaths.csv",sep=",")

nd <- read.csv("Natural disaster.csv", skip = 6,header=T,sep=";")

conflit <- read.csv("Nombre de conflits.csv", header = TRUE,sep=";",check.names=F)

ter<-read.csv("Terrorism.csv")

GDP <- read.csv("gdp-per-capita-maddison-2020.csv")

democ <- read.csv("democracy-polity.csv")
